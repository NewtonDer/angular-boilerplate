module.exports = function ( grunt ) {
	...
	var taskConfig = {
		...
		recess: {
			...
			compile: {
				src: [ 'src/css/*.less', 'src/css/*.css' ],
				dest: '<%= dir.prod %>/css/<%= pkg.name %>.css',
				options: {
					compile: true,
					compress: true,
					noUnderscores: false,
...
/*
		shell: {
			jssrc: {
				command: 'rsync -avz --delete ./bin/dev/app/ "newton@23.23.244.142:/var/www/newton/dev/vrm/app"'
			},

			assets: {
				command: [
					'rsync -avz ./bin/dev/assets/ "newton@23.23.244.142:/var/www/newton/dev/vrm/assets"',
					'rsync -avz ./bin/dev/ajax/ "newton@23.23.244.142:/var/www/newton/dev/vrm/ajax"',
					'rsync -avz ./bin/dev/lib/ "newton@23.23.244.142:/var/www/newton/dev/vrm/lib"'
				].join(';')
			},

			html: {
				command: 'rsync -avz ./bin/dev/index.html "newton@23.23.244.142:/var/www/newton/dev/vrm/index.html"'
			},

			tpls: {
				command: 'rsync -avz ./bin/dev/app/templates-app.js "newton@23.23.244.142:/var/www/newton/dev/vrm/app/templates-app.js"'
			},

			less: {
				command: 'rsync -avz --delete ./bin/dev/css/ "newton@23.23.244.142:/var/www/newton/dev/vrm/css"'
			}
		},
*/
...
//					'src/assets/**/*',
	...
	grunt.registerTask( 'compile', [
		'recess:compile', 'copy:compile_static', 'ngmin', 'concat', 'uglify', 'index:compile'
	]);
